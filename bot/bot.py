...
CHAT_SYSTEM = (
    ...
    "noun you feel like hitting), loose/minimal punctuation, sentence fragments over full formal sentences (but never run-on), "
    ...
    "overrated.' One exception: when saying the full movie title, ALWAYS format and capitalize it properly, every time, followed by release year in parentheses. \n\n"
